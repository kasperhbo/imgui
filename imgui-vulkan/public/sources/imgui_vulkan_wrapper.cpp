#include "imgui_vulkan_wrapper.h"
...
void ImGuiVulkanWrapper::startFrame()
{
...
void ImGuiVulkanWrapper::destroy()
{
    // Cleanup
...
bool ImGuiVulkanWrapper::getShouldClose()
{
    if(window == nullptr)
    {
        return false;
